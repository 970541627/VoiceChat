            ...
            for (int i = 0; i < size; i++) {
                ...
                if (group.getGroupId().equals(groupId)) {
                    ...
                    if (group.joinGroup(joiner)) {
                        ...
                        joiner.sendSystemMessage(Component.literal("该群组人数已满").withColor(0xFFFF0000));
                    }
                    return true;
                }
            }
                ...
                if (canDissolve) {
                    ...
                    for (int i = 0; i < serverPlayers.length; i++) {
                        ...
                        if (joinGroupCache.containsKey(removePlayerName)) {
                            ...
                            serverPlayers[i].sendSystemMessage(Component.literal("群组已解散").withColor(0xFFFF0000));
                        }
                    }
