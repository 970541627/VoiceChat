...
public class NetworkSender {
    ...
    public static void registerS() {
        ...
        channel.messageBuilder(ServerMicDataPacketHandler.class, NetworkDirection.PLAY_TO_SERVER)
                .encoder(ServerMicDataPacketHandler::encode)
                .decoder(ServerMicDataPacketHandler::new)
                .consumerMainThread(ServerMicDataPacketHandler::handle)
                .add();
    ...
    public static void registerC() {
        ...
        channelS.messageBuilder(ClientMicDataPacketHandler.class, NetworkDirection.PLAY_TO_CLIENT)
                .encoder(ClientMicDataPacketHandler::encode)
                .decoder(ClientMicDataPacketHandler::new)
                .consumerMainThread(ClientMicDataPacketHandler::handle)
                .add();
    }
